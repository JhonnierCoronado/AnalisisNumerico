...
PuntoFijo = function(a, b, error){
  ...
  if (Fx(a) < a || Fx(b) < b)
    ...
    plot(valoresX, erroresX, type="l",xlab="Ei", ylab="Ei+1", main="Valores * Errores", col="red")
    
   cat("Iteracciones: ", contador, "Resultado: ", xInicial, "\n")
   
   plot(erroresX, it, type="l", xlab="Errores", ylab="Iteracciones",  main="Iteracciones * Errores", col = "red")
  }
}
